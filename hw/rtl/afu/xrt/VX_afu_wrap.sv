...
`endif
	...
	// Per-bank XRT BO base address offsets. Each AXI request gets offset by
	// the corresponding bank's BO base so that Vortex internal byte addresses
	// land inside the xrt::bo XRT allocated for that bank.
	//
